...
plugins=(brew colored-man colorize docker docker-compose extract git gitfast history osx sublime terminalapp vagrant web-search zsh-syntax-highlighting)
